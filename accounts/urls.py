...
urlpatterns = [
    path("company/", views.CompanySignUpView.as_view(), name="create_employer"),
    path("jobseeker/", views.JobseekerUserView.as_view(), name="create_jobseeker"),
  
  
    path("profile/", views.UserProfileView.as_view(), name="profile"),
    path("profile/edit/", views.UpdateUserProfileView.as_view(), name="edit"),
